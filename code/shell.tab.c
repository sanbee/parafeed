...
/* If NAME_PREFIX is specified substitute the variables and functions
   names.  */
#define yyparse sh_parse
#define yylex   sh_lex
#define yyerror sh_error
#define yylval  sh_lval
#define yychar  sh_char
#define yydebug sh_debug
#define yynerrs sh_nerrs
...
{
       0,     0,     3,     5,     8,    10,    13,    17,    24,    32,
      37,    39,    45,    47,    49,    53,    56,    58,    60,    63,
      65,    69,    72,    75,    77
};
...
{
      15,     0,    -1,     9,    -1,    20,     9,    -1,     8,    -1,
       3,    10,    -1,     3,    10,    17,    -1,     3,    11,     7,
      12,    10,    17,    -1,     3,    11,     7,    12,    10,    13,
       3,    -1,     3,    10,    13,     3,    -1,     5,    -1,    13,
       3,    11,     7,    12,    -1,     6,    -1,     3,    -1,     6,
      13,     3,    -1,     6,    17,    -1,    16,    -1,     4,    -1,
       4,    17,    -1,    18,    -1,     6,    10,    17,    -1,     4,
      10,    -1,    13,     3,    -1,    17,    -1,    19,    -1
};
...
{
  "$end", "error", "$undefined", "VAR", "COMMAND", "STRING", "UNDEF",
  "NUMBER", "FINIS", "'\\n'", "'='", "'['", "']'", "'$'", "$accept",
  "list", "asign", "expr", "externcmd", "comd", "stmt", 0
};
#endif
...
{
       0,    13,    17,    10,    12,     4,     2,     0,     0,    16,
      23,    19,    24,     0,     5,     0,    21,     0,    18,     0,
       0,    15,    22,     1,     3,     0,     6,     0,     0,    20,
      14,     0,     9,     0,     0,     0,    11,     0,     7,     8
};
...
{
       0,    13,     5,    -3,     6,    -3,    -3,     4,     1,    -3,
      -3,    -3,    -3,    17,     9,    18,    -3,    24,    -3,    15,
      27,    -3,    20,    -3,    -3,    29,    -3,    22,    20,    -3,
      20,    28,    20,    26,    25,    16,    -3,    35,    -3,    20
};
...
{
      18,    23,    21,     1,     2,     3,     4,    22,     5,     6,
       3,     3,    26,     7,     3,    16,    19,    29,    17,    20,
       3,     3,    25,    14,    15,    27,    24,    28,    17,    37,
      30,    31,    32,    38,    33,    34,    35,    36,    39
};

static const unsigned char yycheck[] =
{
       2,     0,     4,     3,     4,     5,     6,     3,     8,     9,
       5,     5,    14,    13,     5,    10,    10,    19,    13,    13,
       5,     5,    13,    10,    11,     7,     9,     3,    13,    13,
       3,    11,     3,    35,    12,     7,    10,    12,     3
};
...
static const unsigned char yystos[] =
{
      ...
      17,    18,    19,    20,    10,    11,    10,    13,    17,    10,
      13,    17,     3,     0,     9,    13,    17,     7,     3,    17,
       3,    11,     3,    12,     7,    10,    12,    13,    17,     3
};
...
#line 112 "shell.y"
    {
					...
					for (i=0;i<yyvsp[0].symb->NVals;i++)
					  CopyStr(&s,yyvsp[0].symb->Val[i]);
					SetVal(s,yyvsp[-6].symb,(int)yyvsp[-4].Result);
					FreeStr(&s);
				      }
				    yyval.symb=yyvsp[-6].symb;
				  }
    break;
...
#line 124 "shell.y"
    { 
	                             unsigned int i;
				     for(i=0;i<yyvsp[0].symb->NVals;i++)
				       SetVal(yyvsp[0].symb->Val[i],yyvsp[-3].symb,i);
...
#line 134 "shell.y"
    {
	                           ...
	                           {fprintf(stderr,"###Error: No. of vals=%d\n"
					    ,yyvsp[-3].symb->NVals);yyval.String=NULL;} 
	                           else yyval.String=yyvsp[-3].symb->Val[(int)yyvsp[-1].Result];
                                 }
    break;
...
#line 146 "shell.y"
    {
	                             ...
	                             CopyStr(&sh_sys_cmd," ");
	                             for(i=0;i<yyvsp[0].symb->NVals;i++)
				       CopyStr(&sh_sys_cmd,yyvsp[0].symb->Val[i]);
                                    }
    break;
